...
$(document).ready(function() { 
    ...
    $('#searchOrganization').click(function(){
    	$('#selectedTrade').attr('class','validate[required]');
    	$("#addressRoleBillPrintOptionsForm").attr("action", "findBillPrintOptions");
    	$("#hideCustomAddRow").val("false");
    	$("#hidePagerRow").val("false");
    	$("#addressRoleBillPrintOptionsForm").submit(); 
    
    });
    
    $('#org_save').click(function(){
    	$("#addressRoleBillPrintOptionsForm").attr("action", "createUpdateBillPrintOptions");
    	$("#addressRoleBillPrintOptionsForm").submit(); 
    
    });
    
    $('#org_next').click(function(){
    	$('#selectedTrade').removeClass('validate[required]');
	 	$('#addressRoleBillPrintOptionsForm').attr("action","nextBillPrintOptions");
		$("#addressRoleBillPrintOptionsForm").submit();
		
	});
    
    
	//on change of parent organization ajax call for getting address details
	$('#addressSearch').click(function(){
		$('#org_save').attr('disabled', true);
		overrideAction('findAddressDetails');
    	$("#addressRoleBillPrintOptionsForm").ajaxSubmit(options); 
	});
