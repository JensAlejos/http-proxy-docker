...
function enforceUserSecurityRolesAndPermissions(){
	...
	/*Commodity*/
	_enforceSecuritySection('maintainBookingCommodity', 4, isCommodityDisplayOnly, isCommodityModifiable, isCommodityTitleDisplay);
	
	/*Military*/
	_enforceSecuritySection('militarySection', 5, isMilitaryDisplayOnly, isMilitaryModifiable, isMilitaryTitleDisplay);
	...
	/*Clauses*/
	_enforceSecuritySection('maintainBookingClauses', 7, isClauseDisplayOnly, isClauseModifiable, isClauseTitleDisplay);
	
	/*Holds*/
	_enforceSecuritySection('maintainBookingHold', 8, isHoldManualDisplayOnly, isHoldManualModifiable, isHoldTitleDisplay);
		
	/*Booking Overrides*/
	_enforceSecuritySection('maintainBookingOverrides', 9, isRoutingOverrideDisplayOnly, isRoutingOverrideModifiable, isRoutingOverrideTitleDisplay);
	...
	//Payment
	enforceSecurityDivAndButtons('updatepayment', paymentEnabled);
	
	//Send Doc
	enforceSecurityDivAndButtons('sendDoc', sendDocEnabled);
	
	//Send EDI
	enforceSecurityDivAndButtons('sendEDI', sendEDIEnabled);
	
	//Alerts
	enforceSecurityDivAndButtons('alertBtn', sendAlert);
	
	//Cust Address
	enforceSecurityDivAndButtons('customizeNameAddress', custAddressEnabled);
	
	//Bill
	enforceSecurityDivAndButtons('billBooking', isbillenabled);
	
	//Delete
	enforceSecurityDivAndButtons('bookingDelete', bookingDeleteEnabled);
