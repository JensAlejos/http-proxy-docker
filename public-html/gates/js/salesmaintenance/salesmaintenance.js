$(document).ready(function() {
	...
	//On page load default focus on Region field
	$('#salesRegionCode').focus();
	
	//$('#transferAccounts').focusout(function()
	//{
		//$('#salesRegionCode').focus();
	//});
  ...
  $('#search').click(function(){
	  document.location.href =_context+'/sales/salesMaintenance/get?regionCode='+ $("#salesRegionCode").val();
  ...
  $('#save').click(function(){
	  $('#salesMaintenanceForm').attr("action","createUpdate");
	  $("#salesMaintenanceForm").ajaxSubmit(options);
  });
});
...
function showResponse(responseText, statusText, xhr, $form)  { 
	 ...
	 */
	$('#salesMaintenanceForm').loadJSON(responseText.data);
	...
	if (responseText.messages) {
		...
		$('#jqgrid').html('<table id="gridIdForTerritory"></table><div id="pagerIdForTerritory"></div>');
		makeGrid();
