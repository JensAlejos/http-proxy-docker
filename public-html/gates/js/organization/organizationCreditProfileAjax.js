...
$(document).ready(function() { 
    ...
    $('#creditProfileForm').submit(function() {
...
function showResponse(responseText, statusText, xhr, $form)  { 
	 ...
	 */
	$('#creditProfileForm').loadJSON(responseText.data);
	// msgDiv:
	...
	if (responseText.messages) {
		...
		$('#changeCreditLimitDate').html('').append(responseText.data.creditLimitChangeDateStr);
		$('#changeCreditLimitUser').html('').append(responseText.data.creditLimitChangeUser);
		$('#changeCreditStatusDate').html('').append(responseText.data.creditProfStatusChgDateStr);
		$('#changeCreditStatusUser').html('').append(responseText.data.creditProfStatusChgUserId);
