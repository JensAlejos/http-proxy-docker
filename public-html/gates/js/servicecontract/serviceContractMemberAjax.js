...
$(document).ready(function() { 
	//$("#serviceContractMemberForm").validationEngine('attach', {ajaxFormValidation: true}); 	
    ...
    /*$('#serviceContractMemberForm').submit(function() {
...
function showResponse(responseText, statusText, xhr, $form)  { 
	 ...
	 */
	$('#serviceContractMemberForm').loadJSON(responseText.data);
	// msgDiv:
